...
exports.WidgetAdminController = void 0;
...
class WidgetAdminController {
    static async getWidgets(req, res) {
        try {
            ...
            let widgets;
            if (sidebarId) {
                widgets = await widgetService.getWidgetsBySidebar(sidebarId, theme);
            }
            else {
                widgets = await widgetService.getAllWidgets(theme);
            }
            res.json({
                success: true,
                data: { widgets },
    ...
    static async createWidget(req, res) {
        try {
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'create_widget', widget.id, `Widget: ${widget.widgetId}`, data, req.ip, req.get('User-Agent'));
            res.status(201).json({
                success: true,
                data: { widget },
    ...
    static async getWidget(req, res) {
        try {
            const { id } = req.params;
    ...
    static async updateWidget(req, res) {
        try {
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'update_widget', widget.id, `Widget: ${widget.widgetId}`, data, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
                data: { widget },
    ...
    static async deleteWidget(req, res) {
        try {
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'delete_widget', widget.id, `Widget: ${widget.widgetId}`, undefined, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
    ...
    // Widget types
    static async getWidgetTypes(req, res) {
        try {
    ...
    static async getWidgetGroups(req, res) {
        try {
    ...
    // Sidebars
    static async getSidebars(req, res) {
        try {
    ...
    static async getSidebarWidgets(req, res) {
        try {
            ...
            const widgets = await widgetService.getWidgetsBySidebar(sidebarId, theme);
            res.json({
                success: true,
                data: { widgets },
            });
    ...
    // Reordering
    static async reorderWidgets(req, res) {
        try {
            const { sidebarId, widgetIds } = req.body;
            const { theme = 'default' } = req.query;
            const userId = req.user.id;
            await widgetService.reorderWidgets(sidebarId, widgetIds, theme);
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'reorder_widgets', sidebarId, `Reordered widgets in ${sidebarId}`, { widgetIds, theme }, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
    ...
    // Move widget
    static async moveWidget(req, res) {
        try {
            const { id } = req.params;
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'move_widget', widget.id, `Widget moved to ${sidebarId}`, { sidebarId, position }, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
                data: { widget },
    ...
    // Clone widget
    static async cloneWidget(req, res) {
        try {
            const { id } = req.params;
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'clone_widget', widget.id, `Widget cloned to ${sidebarId}`, { sidebarId, theme }, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
                data: { widget },
    ...
    static async bulkDelete(req, res) {
        try {
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'bulk_delete_widgets', widgetIds.join(','), `${widgetIds.length} widgets deleted`, { count: widgetIds.length }, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
    ...
    static async bulkMove(req, res) {
        try {
            ...
            // Audit log
            await auditService.logContentAction(userId, 'widget', 'bulk_move_widgets', widgetIds.join(','), `${widgetIds.length} widgets moved to ${sidebarId}`, { count: widgetIds.length, sidebarId, theme }, req.ip, req.get('User-Agent'));
            res.json({
                success: true,
...
exports.WidgetAdminController = WidgetAdminController;
