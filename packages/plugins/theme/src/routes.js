...
exports.registerThemeRoutes = registerThemeRoutes;
function registerThemeRoutes(router, ctx, requireAuth, requirePermission) {
    const settingsService = ctx.settings;
    // Get theme options
    router.get('/theme/options', requireAuth, requirePermission('theme.options'), async (req, res) => {
        try {
    ...
    router.post('/theme/options', requireAuth, requirePermission('theme.options'), async (req, res) => {
        try {
