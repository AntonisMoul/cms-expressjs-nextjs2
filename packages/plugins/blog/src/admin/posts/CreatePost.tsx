...
import { PostCreateData } from '../../models/types';
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <input
              ...
              className="w-full text-2xl font-bold border-none outline-none focus:ring-0 p-0"
              value={formData.name}
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6">
              <textarea
                ...
                className="w-full min-h-[400px] border border-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={seoData.index}
                  onChange={(e) => setSeoData(prev => ({ ...prev, index: e.target.value as 'index' | 'noindex' }))}
                >
