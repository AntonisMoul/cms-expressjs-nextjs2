...
function EditMenu() {
    ...
    var _c = (0, react_1.useState)(true), fetchLoading = _c[0], setFetchLoading = _c[1];
    ...
    var fetchMenu = function () { return __awaiter(_this, void 0, void 0, function () {
        var response, menu, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, 4, 5]);
                    return [4 /*yield*/, fetch("/api/menu/menus/".concat(menuId))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
      ...
      <div className="md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Menu</h3>
              ...
              <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    The name of the menu as it appears in the admin.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input type="text" name="slug" id="slug" value={formData.slug} onChange={handleInputChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
                  <p className="mt-1 text-sm text-gray-500">
                ...
                <div>
                  ...
                  <select name="status" id="status" value={formData.status} onChange={handleInputChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    <option value="published">Published</option>
                    <option value="draft">Draft</option>
                  </select>
                  <p className="mt-1 text-sm text-gray-500">
                    Menu status determines if it's available for use.
                  </p>
                </div>
              </div>

              <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                <button type="button" onClick={function () { return router.back(); }} className="inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 mr-3">
                  Cancel
                </button>
