...
exports.MenuPublicController = void 0;
...
class MenuPublicController {
    ...
    static buildMenuHtml(nodes, level = 0) {
    ...
    static async getBreadcrumbs(req, res) {
        try {
            const { menuId, currentUrl } = req.query;
            const menu = await menuService.getMenuWithNodes(menuId);
            if (!menu) {
                return res.json({
                    success: true,
                    data: { breadcrumbs: [] },
    ...
    static buildBreadcrumbTrail(nodes, nodeId) {
        const breadcrumbs = [];
...
exports.MenuPublicController = MenuPublicController;
